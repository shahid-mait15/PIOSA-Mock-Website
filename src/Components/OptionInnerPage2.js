    ...
    <>
      <div className="h-screen">
        <div className="flex gap-6 w-full justify-center p-5">
            ...
            <div className="flex items-center justify-center p-10">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">
                  <a className="text-blue-500">Downloading CFT.</a>
                </p>
              </div>
            </div>
            <p
          ...
          {/* Step 2 */}
          <div
            className={`rounded-2xl shadow-md p-6 bg-white border ${
          ...
          >
            ...
            <div className="flex items-center p-10">
              <div className="ml-4">
                <h2 className=" text-sm font-semibold text-gray-800">
                Have you finished with the CFT deployment ?<br />
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="relative">
                  <div className="flex items-center">
                    <div className="relative w-28 h-8 bg-white border border-black rounded-full flex items-center cursor-pointer">
                      {/* Slider background */}
                      <div
